...
public class MenstrualAppTest{
    ...
    @Test
    public void testThatgetNextFlowStartDateGivesLastPeriodStartDatePlusCycleDuration(){
        MenstrualApp calc = new MenstrualApp();
        LocalDate lastPeriodStartDate = LocalDate.of(2026, 4, 20);
        int cycleDuration = 28;
        LocalDate result = calc.getNextFlowStartDate(lastPeriodStartDate, cycleDuration);
        LocalDate expected = LocalDate.of(2026, 5, 18);
        assertEquals(expected, result);
